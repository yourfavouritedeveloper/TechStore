    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(requests -> requests
                        .requestMatchers("/api/v1/accounts/register", "/api/v1/accounts/login","/api/v1/accounts/otp/send","/api/v1/accounts/otp/verify","/api/v1/products/**","/api/v1/comments/**","/images/**","/videos/**").permitAll()
